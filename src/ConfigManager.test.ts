...
describe("ConfigManager", () => {
  test("Test loading an unparseable configuration", () => {
    ...
    expect(() => {
      configManager.load(configurationString);
    }).toThrow(SyntaxError);
  });
  ...
  test("Test loading an invalid configuration", () => {
    ...
    expect(() => {
      configManager.load(configurationString);
    }).toThrow("Invalid configuration: invalid radius");
  });
  ...
  test("Test loading an invalid configuration, missing some parameter", () => {
    ...
    expect(() => {
      configManager.load(configurationString);
    }).toThrow("Invalid configuration: invalid height");
  });
  ...
  test("Test loading an invalid configuration, invalid mismatch", () => {
    ...
    expect(() => {
      configManager.load(configurationString);
    }).toThrow("Invalid configuration: invalid distance");
  });
