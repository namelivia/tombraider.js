...
describe('TombRaider', function () {
  ...
  beforeEach(function () {
    ...
    camera = {}
    window.THREE.PerspectiveCamera = jasmine
      .createSpy('PerspectiveCamera')
    ...
    window.THREE.WebGLRenderer = jasmine
      .createSpy('WebGLRenderer')
      .and.callFake(function () {
        return renderer
      })
    ...
    directionalLight.position.set = jasmine
      .createSpy('setPosition')
      .and.callFake(function () {
        return vector
      })
    window.THREE.DirectionalLight = jasmine
      .createSpy('DirectionalLight')
      .and.callFake(function () {
  ...
  it('Test the constructor', function () {
    ...
    expect(TombRaiderMenu.prototype.setCameraDistance).toHaveBeenCalledWith(
      12000,
    )
  ...
  it('Test the update function', function () {
    ...
    expect(
      TombRaiderMenu.prototype.objects[TombRaiderMenu.prototype.selected]
        .rotation.y,
    ).toEqual(1.01)
  ...
  it('Test the action function', function () {
    ...
    spyOn(console, 'error')
    TombRaiderMenu.prototype.action()
    expect(console.error).toHaveBeenCalledWith('Unknown action')
  ...
  it('Test the loadModel function', function () {
    ...
    window.THREE.JSONLoader = jasmine
      .createSpy('JSONLoader')
      .and.callFake(function () {
        return loader
      })
  ...
  it('Test the deletion of all objects', function () {
    ...
    spyOn(TombRaiderMenu.prototype, 'deleteSelected').and.callFake(function () {
      TombRaiderMenu.prototype.objects.splice(
        TombRaiderMenu.prototype.selected,
        1,
      )
    })
  ...
  describe('Testing setters', function () {
    ...
    it('Test setting a configuration', function () {
      var newConfig =
        '{"objects":[{"name":"asdfasdf","action":"link","params":"asdfasdf","model":"models/chest/chest.json"},{"name":"asdfasdfasdf","action":"link","params":"asdfasdfsadf","model":"models/chest/chest.json"},{"name":"asdfasdf","action":"link","params":"asdfasdf","model":"models/chest/chest.json"}],"distance":"17800","height":"2600","radius":"10600"}'
      spyOn(TombRaiderMenu.prototype, 'addModel')
  ...
  describe('Testing getters', function () {
    ...
    it('Test getting a JSON config', function () {
      ...
      expect(config.distance).toEqual(
        TombRaiderMenu.prototype.getCameraDistance(),
      )
