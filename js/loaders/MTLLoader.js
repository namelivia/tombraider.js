		...
		for ( var i = 0; i < lines.length; i ++ ) {
			...
			if ( key === "newmtl" ) {
				...
				if ( key === "ka" || key === "kd" || key === "ks" ) {
					...
					info[ key ] = [ parseFloat( ss[0] ), parseFloat( ss[1] ), parseFloat(
ss[2] ) ];
 ...
 *                                  Default: false
 *                  invertTransparency: If transparency need to be inverted (inversion is needed if d = 0 is
 *                  fully opaque)
				...
				switch ( lprop ) {
					...
					case 'ks':
						...
						if ( this.options && this.options.normalizeRGB ) {
							...
							value = [ value[ 0 ] / 255, value[ 1 ] / 255, value[ 2 ]
/ 255 ];
...
=== 0 ) {
					...
					case 'd':
						...
						// According to MTL format
						// (http://paulbourke.net/dataformats/mtl/):
						//   d is dissolve for current material
						//   factor of 1.0 is fully opaque, a factor of 0 is fully
		...
		for ( var prop in mat ) {
			...
			switch ( prop.toLowerCase() ) {
				...
				case 'd':
					...
					//   d is dissolve for current material
					//   factor of 1.0 is fully opaque, a factor of 0 is fully dissolved
